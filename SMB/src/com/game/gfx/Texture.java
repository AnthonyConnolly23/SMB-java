...
public class Texture {
	...
	private BufferedImage[] mario_l, mario_s, tile_1, tile_2, tile_3, tile_4, pipe_1;
	...
	public Texture() {
		...
		try {
			player_sheet = loader.loadImage(PARENT_FOLDER + "/NES - Super Mario Bros. - Playable Characters - Mario & Luigi.png");
			enemy_sheet = loader.loadImage(PARENT_FOLDER + "/NES - Super Mario Bros. - Enemies & Bosses - Enemies & Bosses.png");
			npc_sheet = loader.loadImage(PARENT_FOLDER + "/NES - Super Mario Bros. - Miscellaneous - Items, Objects and NPCs.png");
			block_sheet = loader.loadImage(PARENT_FOLDER + "/NES - Super Mario Bros. - Miscellaneous - Item and Brick Blocks.png");
			tile_sheet = loader.loadImage(PARENT_FOLDER + "/NES - Super Mario Bros. - Miscellaneous - Tileset.png");
			game_over_sheet = loader.loadImage(PARENT_FOLDER + "/NES - Super Mario Bros. - Miscellaneous - Title Screen, HUD and Miscellaneous.png");
			intro_sheet = loader.loadImage(PARENT_FOLDER + "/NES - Super Mario Bros. - Miscellaneous - Title Screen, HUD and Miscellaneous.png");
	...
	private void getPipeTextures() {
		...
		pipe_1[3] = tile_sheet.getSubimage(x_off, y_off, width, height);
